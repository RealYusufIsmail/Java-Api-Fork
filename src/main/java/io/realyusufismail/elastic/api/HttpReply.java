...
public final class HttpReply {
    ...
    private HttpReply(final int status, final InputStream content,
    ...
    public String toString() {
        return "HttpReply{" + "status=" + status + ", headers=" + headers + ", content=" + content
                + '}';
    }
    ...
    public enum Status {
        ...
        /**
         * 200 OK, see
         * <a href="http://www.w3.org/Protocols/rfc2616/rfc2616-sec10.html#sec10.2.1">HTTP/1.1
         * documentation</a>.
         */
        OK(200, "OK"),
        /**
